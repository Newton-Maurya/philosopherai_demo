...
app.post("/get_query", async (req, res) => {
    let topic = req.body.topic;
    let get_topics = await get_responce(topic);
    res.send(JSON.stringify({data: topic}))
})

async function get_responce(topic) {
    let res = await get_philosopher_response({topic: topic});
    return res;
}
